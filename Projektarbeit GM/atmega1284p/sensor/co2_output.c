...
* Author	: Niklas Theis (original author)
			  Dimitri Dening (modified file for atmega1284p)
* Created	: 03.02.2021 14:28:42
* Modified	: 26.11.2021 13:28:49
...
NOTES:
	A separate led_lib.h was added to control the _update_led_ function
	and make it easier to use LEDs in other files.
