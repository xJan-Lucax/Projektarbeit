...
#define LORAWAN_NWKSKWY_ADDRESS 0
#define LORAWAN_APPSKEY_ADDRESS 16
#define LORAWAN_DEV_ADDRESS 32
#define LORAWAN_NWKID_ADDRESS 36 //3 Byte
#define LORAWAN_APPNONCE_ADDRESS 39 //3 Byte
#define LORAWAN_DLS_ADDRESS 42 //1 Byte
#define LORAWAN_RXD_ADDRESS 43 //1 Byte
#define LORAWAN_FORCE_OTAA_JOIN 80 //1 Byte
#define LORAWAN_DEVNONCE_ADDRESS 60 //2 Byte
#define LORAWAN_CHANNELLIST_ADDRESS 62 //15 Byte
#endif
...
void lorawan_otaa_downlink(){	//function will be called, when join-accept message will be received
	...
	if((payload[received_data_length-5] == mic[0]) && (payload[received_data_length-4] == mic[1]) && (payload[received_data_length-3] == mic[2]) && (payload[received_data_length-2] == mic[3])){	
		...
		if(received_data_length == 33){															//if channellist is send
